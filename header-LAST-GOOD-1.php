	...
	<header id="masthead" class="site-header" role="banner">
		<div class="nav-bar">
			...
			<nav id="bt-menu" class="bt-menu">
				...
				<ul>
					<li><a href="https://github.com/codrops" class="bt-icon icon-youtube"><i class="fa fa-apple" aria-hidden="true"></i></a></li>
					...
					<li><a href="https://github.com/codrops" class="bt-icon icon-linkedin">Linkedin</a></li>
				</ul>
			</nav>
		</div> <!-- END NAV BAR -->
		...
		<div class="btn-box">
			...
			<article class="btn-container text-center">
				...
				<div class="flex-item">
					<a class="btn btn-primary btn-md" href="#">VIEW PROPERTY DETAILS</a>
				</div>
				<div class="flex-item">
					<a class="btn btn-primary btn-md" href="#">CALL: (941) 229-0213</a>
				</div>
				<div class="flex-item">
                ...
                <section id="popup-form-click" class="clearfix">
                    ...
                    <article class="popup-text">
                        ...
                        <figure>
                        	...
                        	<?php the_field( 'optin_in_form_code' ); ?>
